...
RSpec.describe InformationController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      information = Information.create! valid_attributes
      get :show, params: {id: information.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Information" do
        expect {
          post :create, params: {information: valid_attributes}, session: valid_session
      ...
      it "renders a JSON response with the new information" do
        ...
        expect(response.location).to eq(information_url(Information.last))
      end
    end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested information" do
      information = Information.create! valid_attributes
      expect {
        delete :destroy, params: {id: information.to_param}, session: valid_session
      }.to change(Information, :count).by(-1)
    end
  end
